...
import (
	...
	rjmodule "rj/x/rj"
	rjmodulekeeper "rj/x/rj/keeper"
	rjmoduletypes "rj/x/rj/types"
...
type App struct {
	*baseapp.BaseApp
	...
	RjKeeper rjmodulekeeper.Keeper
...
func New(
	...
	app.RjKeeper = *rjmodulekeeper.NewKeeper(
		appCodec,
		keys[rjmoduletypes.StoreKey],
		keys[rjmoduletypes.MemStoreKey],
		app.GetSubspace(rjmoduletypes.ModuleName),
	)
	rjModule := rjmodule.NewAppModule(appCodec, app.RjKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(rjmoduletypes.ModuleName)
